...
public class AdvancedWidgetActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "AdvancedWidgetActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advancedwidget);
        initView();
        initViewPager();
    }
    ...
    private void initViewPager() {
        ...
        */
        ...
        fragments.add(new MaterialDesignFragment());
