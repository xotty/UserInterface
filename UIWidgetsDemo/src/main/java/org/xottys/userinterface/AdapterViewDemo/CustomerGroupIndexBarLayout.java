...
public class CustomerGroupIndexBarLayout extends LinearLayout implements View.OnTouchListener {
    ...
    public CustomerGroupIndexBarLayout(Context context) {
        this(context, null);
    }

    public CustomerGroupIndexBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomerGroupIndexBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        //获取视图的颜色和尺寸
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.CustomerGroupIndexBarLayout);
        final float fontScale = getResources().getDisplayMetrics().scaledDensity;
        int pos= (int) (12 * fontScale + 0.5f);
        float indexTextSize = ta.getDimension(R.styleable.CustomerGroupIndexBarLayout_indexTextSize, pos);
        int indexTextColor = ta.getColor(R.styleable.CustomerGroupIndexBarLayout_indexTextColor, 0xFF616161);
        ta.recycle();
