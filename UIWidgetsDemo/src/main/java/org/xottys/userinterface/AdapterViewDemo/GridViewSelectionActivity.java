 ...
 */
public class GridViewSelectionActivity extends Activity {
    ...
    private class AppsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                i = new ImageView(GridViewSelectionActivity.this);
                i.setScaleType(ImageView.ScaleType.FIT_CENTER);
                i.setLayoutParams(new ViewGroup.LayoutParams(150, 150));
                l = new CheckableLayout(GridViewSelectionActivity.this);
