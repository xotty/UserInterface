 ...
 */
public class AdvancedSelectionModeActivity extends ListActivity {
    @Override
    ...
    private class ModeCallback implements ListView.MultiChoiceModeListener {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            case R.id.share:
                Toast.makeText(AdvancedSelectionModeActivity.this, "Shared " + getListView().getCheckedItemCount() +
                        " items", Toast.LENGTH_SHORT).show();
                mode.finish();
                break;
            default:
                Toast.makeText(AdvancedSelectionModeActivity.this, "Clicked " + item.getTitle(),
