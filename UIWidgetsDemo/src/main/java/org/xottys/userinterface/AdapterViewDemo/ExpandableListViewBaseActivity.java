 ...
 */
public class ExpandableListViewBaseActivity extends ExpandableListActivity {
    private static final String TAG = "ExpandableListViewBaseActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getExpandableListView().setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            {
                Toast.makeText(ExpandableListViewBaseActivity.this, "第" + var3 + "个父项被点击了", Toast.LENGTH_SHORT).show();
        ...
        getExpandableListView().setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                Toast.makeText(ExpandableListViewBaseActivity.this, "第" + i1 + "个子项被点击了", Toast.LENGTH_SHORT).show();
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView() {
            ...
            TextView textView = new TextView(ExpandableListViewBaseActivity.this);
