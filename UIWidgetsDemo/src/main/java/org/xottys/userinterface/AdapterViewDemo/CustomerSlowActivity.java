 ...
 * 1)onScrollStateChanged中修改listview滚动状态
 * 2)getViw中根据listview滚动状态给ViewHolder赋值：
 * TOUCH_SCROLL或FLING时赋值虚拟数据"Loding..."，IDLE时，填入真实数据
 * <p>
 ...
 *
 */
public class CustomerSlowActivity extends ListActivity implements ListView.OnScrollListener {
