 ...
 * 1)使用外置的自定义Adapetr：CustomerGroupAdapter
 * 2)ListView Item中有两种不同格式：字母索引+内容
 * 3)使用注解方式来代替findViewById方法，关联变量和布局文件中的控件
 * 4)实现了常用的右侧边栏字母索引功能,右侧边栏字母视图通过自定义的LinearLayout来实现
 * <p>
...
public class CustomerGroupActivity extends Activity implements OnItemClickListener, CustomerGroupIndexBarLayout.OnIndexChangedListener {
    ...
    private CustomerGroupIndexBarLayout ibIndicator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customergroupadapter);
        ...
        lvCompany.setAdapter(new CustomerGroupAdapter(mCompanyList));
