...
public class AdvancedTranscriptModeActivity extends ListActivity implements OnClickListener, OnKeyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advancedtranscriptmode);
